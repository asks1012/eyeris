...
class distProgCord extends StatefulWidget {
  const distProgCord({Key? key}) : super(key: key);

  @override
  State<distProgCord> createState() => _distProgCordState();
}

class _distProgCordState extends State<distProgCord> {
  @override
  void initState() {
    super.initState();
    myempid.text = "--";
                  ...
                  MaterialButton(
                    ...
                    onPressed: () async {
                      ...
                      if (_formKey.currentState!.validate()) {
                        ...
                        final uri = Uri.parse("$url/registerDPCEmp");
                        try {
