...
class progOfficer extends StatefulWidget {
  const progOfficer({Key? key}) : super(key: key);

  @override
  State<progOfficer> createState() => _progOfficerState();
}

class _progOfficerState extends State<progOfficer> {
  @override
  void initState() {
    super.initState();
    myempid.text = "--";
  ...
  Widget build(BuildContext context) {
    ...
    Future<int> genID() async {
      ...
      id = "";
      id = customAlphabet('1234567890', 7);
      id = "PO$id";
                  ...
                  MaterialButton(
                    ...
                    onPressed: () async {
                      ...
                      if (_formKey.currentState!.validate()) {
                        ...
                        final uri = Uri.parse("$url/registerPOEmp");
                        try {
